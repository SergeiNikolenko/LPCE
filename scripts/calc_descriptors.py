...
data_unique = data_unique[
    data_unique["mol"].parallel_apply(lambda x: x is not None)
]

mols = data_unique["mol"].tolist()

num_unique_structures = len(data_unique)
print("Количество уникальных структур после удаления дубликатов и некорректных молекул:", num_unique_structures)

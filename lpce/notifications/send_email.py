import yagmail
import os
from config.settings import EMAIL_USER, EMAIL_PASSWORD, RECEIVER_EMAIL
...
def send_email_notification(new_structures: int):
    ...
    print(f"Email sent to {RECEIVER_EMAIL} from {EMAIL_USER} with subject '{subject}' and body '{body}'")

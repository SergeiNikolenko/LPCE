...
@op
def run_decompress_pdb_files(extracted: int):
    ...
    input_directory = "/mnt/ligandpro/db/PDB/pdb2/raw/pdb"
    output_directory = "/mnt/ligandpro/db/PDB/pdb2/processed"
    decompress_pdb_files(input_directory, output_directory)